% This script starts up the environment needed by VLFEAT toolbox and check 
%   if there is loaded data in the workspace.

% Written by Qiong Wang for MEAM 620 at the University of Pennsylvania.
% April.16th, 2013

% Check if there is loaded data in the workspace.
if ~(exist('sensorLog','var')||exist('qdLog','var'))
    disp('No quadrotor data or sensor data in the workspace.');
    disp('Loading data...')
    load('proj2phase3log.mat');
    disp('Data loading is done!')
else
   disp('Data are already in the workspace.') 
end
