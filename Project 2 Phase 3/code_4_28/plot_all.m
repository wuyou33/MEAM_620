...
figure()
subplot(3,2,1); 
plot(t(posLog),vicon(4,posLog)+1.44,'r','LineWidth',1.5);hold on;
...
subplot(3,2,3); 
plot(t(posLog),vicon(5,posLog)+1.25,'r','LineWidth',1.5);hold on;
...
% 3D Plot.
figure()
plot3(vicon(4,posLog)+1.44,vicon(5,posLog)+1.25,vicon(6,posLog),'r','LineWidth',1.5); grid on; hold on;
