...
%             R2 = bsxfun(@min, r2, r2_new);
            ...
            R2 = r2(reachable_index_min(1):reachable_index_max(1), reachable_index_min(2):reachable_index_max(2), reachable_index_min(3):reachable_index_max(3));
            R2_new = bsxfun(@min, R2, valid_cost);
            
            
            % SET PARENTS
            
            [x_idx1, y_idx1, z_idx1] = ind2sub(size(valid_cost), find(R2 ~= R2_new));
            parent(reachable_index_min(1) + x_idx1 - 1, reachable_index_min(2) + y_idx1 - 1, reachable_index_min(3) + z_idx1 - 1) = idx;
            
            r2(reachable_index_min(1):reachable_index_max(1), reachable_index_min(2):reachable_index_max(2), reachable_index_min(3):reachable_index_max(3)) = R2_new;
