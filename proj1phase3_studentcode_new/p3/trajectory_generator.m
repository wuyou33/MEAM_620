...
if t >= end_time
    ...
    for i  = path_size:-1:valid_start
        ...
        if ~sum(collide(map0, points))
            ...
            % calculate the factors of the 5th order polynomial
            ...
            % calculate the largest accelerations
            ...
            while norm(acc_max(1, 1:2)) >= 8.5 || abs(acc_max(1, 3)) >= 14 || norm(acc_max(2, 1:2)) >= 8.5 || abs(acc_max(2, 3)) >= 7
